NexusJS.Tests.UtilTests = function(){
	module("Util Tests");  	
	...
	test("should handle one", function() {
		...
		//Act
		var result = NexusJS.Util.handleOneOrMany(stuffToHandle, handlerFunction);
	...
	test("should handle many and return single value", function() {
		...
		//Act
		var result = NexusJS.Util.handleOneOrMany(stuffToHandle, handlerFunction, resultFunction);
